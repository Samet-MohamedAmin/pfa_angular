...
this.filterTrainings()
  ...
  filterTrainings() {
    console.log(this.activeBranch ,this.levels ,this.searchValue,this.trainingType) 
    this.filteredTrainings=this.trainingList.filter((training:any)=>{
      ...
      //only 2 filters are active
        ...
        console.log('6')
        condition= training.concernedBranches.includes(this.activeBranch) && training.type==this.trainingType
